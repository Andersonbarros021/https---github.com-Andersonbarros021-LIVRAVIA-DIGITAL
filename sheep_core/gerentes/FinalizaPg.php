    ...
    private function FinalCompra()
    {
        ...
        $clientId = 'Client_Id_'; // insira seu Client_Id, conforme o ambiente (Des ou Prod)
        $clientSecret = 'Client_Secret_'; // insira seu Client_Secret, conforme o ambiente (Des ou Prod)
